/**
 * NOTE - for testing purposes, the code starting at line 37 generates random
 * users for mock data The "in-memory" test version has been commented out, the
 * app is curently correctly using the Firebase DB
 */
angular.module('dvelop.search', ['dvelop.auth'])
  .controller('SearchController', function ($scope, SearchService, logout, $location, $firebaseArray, $firebaseObject) {
    ...
    /*//it is possible that you call object as an array using $firebaseArray;
     // search.users = $firebaseObject(new
     // Firebase("https://amber-inferno-2562.firebaseio.com/users")); //object
     // version console.log('usersinDB:',search.users);
     //logout func*/
  ...
  .factory('SearchService', function ($http, $rootScope, $firebaseArray) {
    ...
    /*////////////////////////////////////////////////////
     ...
     //Pass into userGenerator the number of random users you want to generate
     // for mock data testing purposes - DO NOT COMMENT OUT, IT WILL BREAK THE
     // APP
     ...
     // searchService.userRef.$add(user); //array version //object version
     searchService.userRef.child(searchService.users[i].userID).update(user);
     }*/
